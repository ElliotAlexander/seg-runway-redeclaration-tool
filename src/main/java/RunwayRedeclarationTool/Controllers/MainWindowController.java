...
public class MainWindowController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle bundle) {
        ...
        Airport airport = new Airport("Heathrow", "EGLL");
        DB_controller.instance.add_airport(airport);
        airportComboBox.getItems().addAll(airport);
        ...
        runwayComboBox.getItems().addAll(runway1);
        runwayComboBox.getItems().addAll(runway2);
        runwayComboBox.setValue(runway2);
